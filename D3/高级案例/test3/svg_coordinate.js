/**
 * 使用uglifyjs压缩混淆
 * 	node uglifyjs coordinate.js -m -o coordinate.min.js
 */
var coordinate = new Function();
...
coordinate.findArrowPoint = function (x1, y1, x2, y2, rectWidth, rectHeight) {
    ...
    var mideAngle = Math.abs(coordinate.findAngle(0, 0, rectWidth, rectHeight));
    var x_offset = 0;
    var y_offset = 0;
    if (1 === selection) {
        if (angle === mideAngle) {
